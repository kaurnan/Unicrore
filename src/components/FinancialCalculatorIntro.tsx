      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <AnimatedSection className="text-center mb-12 animate-fade-in-up">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-8">
            ...
            <span className="font-semibold text-green-600">absolutely free, no requirement</span>
          </p>

          <div className="flex items-center justify-center text-sm text-purple-600 mb-8">
            <Users className="h-4 w-4 mr-2" />
            <span>
              Joined by <span className="font-bold">{userCount.toLocaleString()}</span> smart investors
            </span>
          </div>
        </AnimatedSection>
          ...
          <Card className="border-purple-200 shadow-lg overflow-hidden">
            <div className="bg-gradient-to-r from-purple-600 to-purple-800 p-6 relative">
              ...
              <h3 className="text-2xl font-bold text-white text-center">
                Take control of your financial future in just 2 minutes.
              </h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      Our calculator has helped thousands of users achieve their financial goals. With over 15,000
                      successful financial plans created, our tool provides actionable insights that have transformed
        ...
        {/* FAQ Section - Hidden since it will be in the modal */}
        ...
        {/* Help Modal */}
        <CalculatorResources open={ResourcesModalOpen} onOpenChange={setResourcesModalOpen} />
      </div>
    </section>
  )
}
